...
function firstNameKeyLastNameValue (str1,str2,str3){
	...
	var arrayName1 = str1.split(" ");
	var arrayName2 = str2.split(" ");
	var arrayName3 = str3.split(" ");

	var newObject = { };
		newObject[arrayName1[0]] = arrayName1[1];
		newObject[arrayName2[0]] = arrayName2[1];
		newObject[arrayName3[0]] = arrayName3[1];
